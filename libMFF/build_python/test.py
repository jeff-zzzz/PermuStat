...
filePath ='/Users/jesong1126/Python27/GeoPy/mff_python/test_data/testInput_4cat.mff'
...
ww = libMFF.MFFWriter()
isOpen = ww.openFile('/Users/jesong1126/Python27/GeoPy/mff_python/test_data/VGT105_stat.mff')

# First we create an Info object.
info = libMFF.PyInfo()
info.setMFFVersion(3)
info.setRecordTime("2015-01-29T00:00:00.000000-07:00")
...
infoN = rr.getInfoN(0)
rr.readSignalBlocksFromInfoN('/Users/jesong1126/Python27/GeoPy/mff_python/test_data/testInput_4cat.mff/signal1.bin', infoN, 0, -1)
